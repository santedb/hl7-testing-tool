...
namespace HL7TestingTool
{
  ...
  public interface ITestSuiteBuilder
  {
    ...
    void AddTestCase(int caseNumber);

    /// <summary>
    /// Test steps are built into a specific test case based on a test case number.
    /// </summary>
    /// <param name="caseNumber"></param>
    void AddTestStep(int caseNumber, int stepNumber, string message);
    ...
    void AddExpectedResults(TestStep testStep, List<ExpectedResult> expectedResults);
    ...
    //void UpdateTestStep(TestStep testStep, string message);
    ...
    //void UpdateTestStep(TestStep testStep, List<ExpectedResult> expectedResults);
    ...
    /// <param name="message"></param>
    /// <param name="expectedResults"></param>
    //void UpdateTestStep(TestStep testStep, string message, List<ExpectedResult> expectedResults);
